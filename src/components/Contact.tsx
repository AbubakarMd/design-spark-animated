...
import { MessageCircle, Mail, MapPin, Phone, Send, Star } from "lucide-react";
...
const Contact = () => {
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-gradient-to-br from-secondary/10 to-primary/5">
          ...
          <div className={`space-y-8 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-8">
                ...
                Whether you need a complete brand identity, web design, or just want to discuss 
                an idea, I'm here to help bring your vision to life.
              </p>
            </div>
                  ...
                  <div className="sm:flex items-center gap-4">
                    <div className="flex flex-1 gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-muted-foreground">Collabwithabu@gmail.com</p>
                      </div>
                    </div>
            ...
            <Card className="shadow-elegant border-0 bg-white/90 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <p className="text-xs text-muted-foreground text-center mt-4">
                  Your message will be sent directly to my WhatsApp for faster response
                </p>
              </CardContent>
            </Card>
          </div>
